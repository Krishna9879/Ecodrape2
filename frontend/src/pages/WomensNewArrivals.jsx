...
const WomensNewArrivals = () => {
  ...
  const womensProducts = [
    { id: 1, name: "printed kafkan", price: "₹7,599", images: productImages[1], description: "Flowing maxi with hand-printed leaves" },
    { id: 2, name: "Organic printed top", price: "₹7,199", images: productImages[2], description: "Luxurious silk with floral eco-prints" },
    { id: 3, name: "Natural Cotton kurta", price: "₹5,799", images: productImages[3], description: "Cozy cardigan with botanical patterns" },
    ...
    { id: 7, name: "Natural Hemp Top", price: "₹11,499", images: productImages[7], description: "Professional blazer in sustainable hemp" },
    { id: 8, name: "Botanical Print frok", price: "₹10,199", images: productImages[8], description: "Stylish jumpsuit with nature patterns" },
    { id: 9, name: "Organic Printed Saree", price: "₹6,299", images: productImages[9], description: "Comfortable palazzo pants in earth tones" },
    { id: 10, name: "Handcrafted Cotton Saree", price: "₹5,299", images: productImages[10], description: "Flowing tunic with leaf motifs" },
    { id: 11, name: "Natural Silk Saree", price: "₹12,699", images: productImages[11], description: "Elegant kimono with botanical designs" },
    { id: 12, name: "Sustainable Shrug Dress", price: "₹7,999", images: productImages[12], description: "Flattering wrap dress with eco-prints" },
    { id: 13, name: "Onion Skin Dress", price: "₹6,199", images: productImages[13], description: "Classic shirt in natural linen" },
    { id: 14, name: "A line long Dress", price: "₹3,899", images: productImages[14], description: "Lightweight tank with leaf patterns" },
    { id: 15, name: "Blazer Set", price: "₹4,399", images: productImages[15], description: "Comfortable shorts in sustainable hemp" },
    { id: 16, name: "Long Gown", price: "₹3,399", images: productImages[16], description: "Delicate camisole with plant-based dyes" },
    { id: 17, name: "Short-Kaftan", price: "₹7,199", images: productImages[17], description: "Flowing maxi skirt with botanical prints" },
    { id: 18, name: "A line Short Dress", price: "₹7,499", images: productImages[18], description: "Comfortable dress in organic cotton" },
    { id: 19, name: "Co- ord dress", price: "₹6,999", images: productImages[19], description: "Cozy poncho with earth-tone prints" },
    { id: 20, name: "Grey Co-ord dress", price: "₹4,199", images: productImages[20], description: "Stretchy leggings with leaf designs" },
    { id: 21, name: "White Overlapped Set", price: "₹13,399", images: productImages[21], description: "Professional blazer in natural linen" },
    { id: 22, name: "White Kaftan", price: "₹5,199", images: productImages[22], description: "Flattering wrap top with natural dyes" },
    { id: 23, name: "Plazo Set", price: "₹7,699", images: productImages[23], description: "Comfortable hoodie with botanical details" },
    { id: 24, name: "Shirt Dress", price: "₹4,699", images: productImages[24], description: "Luxurious scarf with eco-prints" },
    { id: 25, name: "Yellow Kaftan", price: "₹6,699", images: productImages[25], description: "Light sundress with nature motifs" },
    { id: 26, name: "Shirt Shorts", price: "₹5,499", images: productImages[26], description: "Versatile vest in sustainable hemp" },
    { id: 27, name: "Shrug Dress", price: "₹3,699", images: productImages[27], description: "Trendy crop top with plant dyes" }
  ]
